...
If you *do* have an application with captured AI traffic, [`05-RUNBOOK.md`](05-RUNBOOK.md) §5 is
...
directly). See [`06-PROVIDERS.md`](06-PROVIDERS.md).
...
| `cost unknown` for an arm | The endpoint reported no cost and the model has no pricing row. Pass `--pricing` (see [`05-RUNBOOK.md`](05-RUNBOOK.md) §9). |
...
See also: [`05-RUNBOOK.md`](05-RUNBOOK.md) §8b–8c (arms and the corpus in depth) ·
[`06-PROVIDERS.md`](06-PROVIDERS.md) · [`03-GUIDE-Setting-the-Bar.md`](03-GUIDE-Setting-the-Bar.md)
