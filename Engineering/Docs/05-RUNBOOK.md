...
Task-oriented. For the architecture and how to extend it, see [`13-CODE-OVERVIEW.md`](./13-CODE-OVERVIEW.md).
...
> **No application, just your own prompts?** Use [`02-GUIDE-Measure-Your-Own-Prompts.md`](02-GUIDE-Measure-Your-Own-Prompts.md) instead. It turns a folder of everyday prompts into a workload and gives you one recipe to run.
...
it a deletion candidate (`07-RUBRICS.md` §8). Use the `arm.*` metrics (`07-RUBRICS.md` §3);
